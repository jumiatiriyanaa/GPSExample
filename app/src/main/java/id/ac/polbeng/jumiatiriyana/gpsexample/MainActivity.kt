package id.ac.polbeng.jumiatiriyana.gpsexample
...
import id.ac.polbeng.jumiatiriyana.gpsexample.databinding.ActivityMainBinding
            ...
            if (exception is ResolvableApiException){
                // Location settings are not satisfied, but this can be fixed
                        ...
                        try {
                            ...
                            // and check the result in onActivityResult(). exception.startResolutionForResult(this@MainActivity, 100)
